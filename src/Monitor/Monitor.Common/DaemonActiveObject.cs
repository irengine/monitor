...
namespace Monitor.Common
{
    ...
    /// </remarks>
    public class DaemonActiveObject : IActiveObject
    {
        ...
        /// See the Start()/Stop() method for more.
        /// </summary>
        private ManualResetEvent m_DaemonEvent;
        ...
        public void Initialize(string name, Action action)
        {
            ...
            m_DaemonEvent = new ManualResetEvent(false);
